...
function printElements(apiResponse, city, state, country) {
  document.querySelector('#showResponse').innerText = `The humidity in ${city}, ${state}, ${country} is ${apiResponse.main.humidity}%.
  The temperature in Fahrenheit is ${apiResponse.main.temp} degrees.
  The wind speed in ${city} is ${apiResponse.wind.speed} mph with gusts of ${apiResponse.wind.gust} mph`;
}
